                            ...
                            <td>
                                ...
                                {{-- Cancel --}}
                                    <div class="items-center flex">
                                        <form action="{{ route('admin.cancel', $applicant->id) }}" method="POST" class="inline-flex items-center p-3 bg-yellow-300 hover:bg-yellow-500 text-white text-sm font-medium rounded-md">
                                            @csrf
                                            <button type="submit" class="flex items-center justify-center p-0">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-arrow-counterclockwise h-5 w-5" viewBox="0 0 16 16">
