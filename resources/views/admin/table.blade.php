            ...
            <table id="example" class="stripe hover" style="width:100%; padding-top: 1em; padding-bottom: 1em;">
                <thead>
                    <tr>
                        ...
                        <th data-priority="3">Family Name</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="items-center flex gap-2">
                                    <!-- Edit Button -->
                                    <a href="/admin/{{ $user->id }}" class="inline-flex items-center p-3 bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium rounded-md">
                                    ...
                                    <!-- View Button -->
                                    <a href="/admin/{{ $user->id }}" class="inline-flex items-center p-3 bg-indigo-500 hover:bg-indigo-600 text-white text-sm font-medium rounded-md">
