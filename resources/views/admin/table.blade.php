                ...
                <tbody>
                    @foreach($applicants as $index => $applicant)
                        <tr>
                            ...
                            <td>{{ $applicant->document->phone_number }}</td>
                            <td>{{ $applicant->document->created_at }}</td>
                            <td>
                                <div class="items-center flex gap-2">
                                    <!-- Edit Button -->
                                    <a href="/admin/{{ $applicant->id }}" class="inline-flex items-center p-3 bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium rounded-md">
