...
@section('title', 'Announecement of Administrative Selection Results for Garuda Scholarship at Universitas Dian Nuswantoro, Indonesia')
@section('content')
    <section class="mx-3">
        {{-- Breadcrumb --}}
        <nav class="text-black font-bold my-6" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
                ...
                <li>
                    <a href="{{ route('admin.showBlog', $blog->id) }}" class="text-gray-500" aria-current="page">{{ $blog->title }}</a>
                </li>
            </ol>
        </nav>
        {{-- Blog Content --}}
        <div class="w-full mx-auto mt-3 bg-white p-6 rounded-lg shadow-lg">
            ...
            <img class="w-full h-72 object-cover mt-4 rounded-lg" src="{{ asset('storage/' . $blog->image) }}" alt="Scholarship announcement">
