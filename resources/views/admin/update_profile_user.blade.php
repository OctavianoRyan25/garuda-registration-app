    ...
    <section class="container self-center">
        <nav class="text-black font-bold my-6" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
                ...
                <li class="flex items-center">
                    <a href="{{ route('admin.showEditForm', $applicant->id) }}" class="text-gray-500">Update Profile ({{ $applicant->document->first_name . ' ' . $applicant->document->family_name }})</a>
                </li>
            </ol>
        </nav>
        <div class="container">
            <div class="flex justify-center">
                <div class="w-full lg:w-full bg-white p-8 rounded-xl mx-3">
                    <h3 class="flex flex-col mb-5 text-center text-2xl font-bold">Update {{ $applicant->document->first_name . ' ' . $applicant->document->family_name }} Profile</h3>
                    {{-- Session has success --}}
                    @if (session('success'))
