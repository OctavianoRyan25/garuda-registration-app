                ...
                <div id="dropDownFilter" class="hidden absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                    <div class="py-1" role="none">
                        <form method="GET" action="{{ route('admin.allData') }}" role="none">
                            ...
                            <button type="submit" class="block w-full px-4 py-2 text-left text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-3">First Name (A-Z)</button>
                        </form>
                        <form method="GET" action="{{ route('admin.allData') }}" role="none">
                            <input type="hidden" name="sort" value="first_name_desc">
                            <button type="submit" class="block w-full px-4 py-2 text-left text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-3">First Name (Z-A)</button>
                        </form>
                        <form method="GET" action="{{ route('admin.allData') }}" role="none">
                            <input type="hidden" name="sort" value="family_name_asc">
                            <button type="submit" class="block w-full px-4 py-2 text-left text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-3">Family Name (A-Z)</button>
                        </form>
                        <form method="GET" action="{{ route('admin.allData') }}" role="none">
                            <input type="hidden" name="sort" value="family_name_desc">
                            <button type="submit" class="block w-full px-4 py-2 text-left text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-3">Family Name (Z-A)</button>
                        </form>
                        <form method="GET" action="{{ route('admin.allData') }}" role="none">
                            <input type="hidden" name="sort" value="nationality_asc">
                            <button type="submit" class="block w-full px-4 py-2 text-left text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-3">Nationality Name (A-Z)</button>
                        </form>
                        <form method="GET" action="{{ route('admin.allData') }}" role="none">
                            <input type="hidden" name="sort" value="nationality_desc">
                            <button type="submit" class="block w-full px-4 py-2 text-left text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-3">Nationality Name (Z-A)</button>
                        </form>
                        <form method="GET" action="{{ route('admin.allData') }}" role="none">
                            <input type="hidden" name="sort" value="department_asc">
                            <button type="submit" class="block w-full px-4 py-2 text-left text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-3">Department Name (A-Z)</button>
                        </form>
                        <form method="GET" action="{{ route('admin.allData') }}" role="none">
                            <input type="hidden" name="sort" value="department_desc">
                            <button type="submit" class="block w-full px-4 py-2 text-left text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-3">Department Name (Z-A)</button>
                        </form>
                    </div>
                </div>
            </div>
