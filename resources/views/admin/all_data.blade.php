...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <h2 class="flex flex-col mb-5 text-center text-2xl font-bold">All Data</h2>
            ...
            <table id="sortable-table" class="min-w-full bg-white border border-gray-200">
                <thead class="bg-[#003d7a] text-white">
                    <tr>
                        ...
                        <th class="py-3 px-4 cursor-pointer" onclick="sortTable(2)">First Name</th>
                        <th class="py-3 px-4 cursor-pointer" onclick="sortTable(3)">Family Name</th>
                        ...
                        <th class="py-3 px-4 cursor-pointer">Registered At</th>
                        ...
                        <tr class="even:bg-slate-200">
                            ...
                            <td class="py-2 px-4 border-b">
                                <div class="items-center flex gap-1">
                                    <!-- Edit Button -->
                                    <a href="{{ route('admin.showEditForm', $applicant->apply_id) }}" class="inline-flex items-center p-2 bg-yellow-500 hover:bg-yellow-600 text-white text-sm font-medium rounded-md">
                                    ...
                                    <!-- Delete Button -->
                                    <form action="{{ route('admin.destroy', $applicant->apply_id) }}" method="POST" class="inline-flex items-center p-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-md">
                                        @method('DELETE')
                                        @csrf
                                    ...
                                    <!-- View Button -->
                                    <a href="{{ route('admin.showApplicant', $applicant->apply_id) }}" class="inline-flex items-center p-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium rounded-md">
