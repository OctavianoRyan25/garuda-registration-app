                    ...
                    <div class="flex">
                            <div class="p-4 px-4 md:p-8 mb-6">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                                    <div class="text-gray-600 flex flex-col items-center text-center md:items-start md:text-start">
                                        <p class="text-lg font-bold">Personal Details</p>
                                        <div class="me-3 mt-3 sm:mt-2">
                                            <img src="{{ asset('storage/' . $apply_data->document->profile_picture) }}" alt="" class="rounded h-52 md:h-auto sm:h-40 sm:w-40 object-cover">
                                        </div>
                                    </div>
