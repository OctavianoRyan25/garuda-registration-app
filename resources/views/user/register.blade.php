    ...
    <section class="flex flex-col md:flex-row h-screen items-center">
        ...
        <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
            ...
            <div class="w-full h-100">
                ...
                @endif
                <form class="mt-6" action="#" method="POST" action="{{ route('user.register') }}">
                    @csrf
                    <div>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="password" name="password_confirmation" id="" placeholder="Enter Password" minlength="6" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
                        focus:bg-white focus:outline-none" required>
                    ...
                    <div class="text-right mt-2">
                        <a href="#" class="text-sm font-semibold text-gray-700 hover:text-yellow-700 focus:text-yellow-700">Forgot Password?</a>
                    </div>
                ...
                <p class="mt-8">Already have an account? <a href="/login" class="text-yellow-500 hover:text-yellow-700 font-semibold">Login</a></p>
                </div>
            </div>
        </section>
</body>
